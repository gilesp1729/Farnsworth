...
Testing the motor with the [Spintend Ubox 100V/100A Vesc](https://spintend.com/collections/esc-based-on-vesc/products/single-ubox-aluminum-controller-100v-100a-based-on-vesc). On the left is a [20 amp buck converter]([Buy CNC Adjustable Power Supply (20A 1200W, LCD Display) Online | Kogan.com](https://www.kogan.com/au/buy/connecttriad-cnc-adjustable-power-supply-20a-1200w-lcd-display-is34049-1-ctxxy-0515/?utm_campaign=postsaleorderconfirm&utm_medium=email&utm_source=kogan)) that takes 48V in from the battery and allows current limiting.
